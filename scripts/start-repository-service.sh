...
# Repository Service Startup Script
# Port: 38102 (Repository Service)
# This script helps start the repository service in development mode
...
SERVICE_PORT="38102"
DESCRIPTION="Central repository management for documents, modules, and configurations"
...
set_registration_host "repository" "REPOSITORY_SERVICE_HOST"
...
echo "  Service Host: $REPOSITORY_SERVICE_HOST"
...
print_status "info" "DevServices will automatically start: MySQL, Kafka, Apicurio, etc."
