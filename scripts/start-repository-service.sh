...
# Port: 38102 (Repository Management Service)
...
SERVICE_PORT="38102"
DESCRIPTION="Central repository management service for documents, modules, and configurations"
...
set_registration_host "repository-service" "PLATFORM_REGISTRATION_HOST"
...
print_status "info" "DevServices will automatically start: MySQL, Kafka, Consul, Redis, etc."
