...
You can then execute your native executable with: `./build/repo-service-1.0.0-SNAPSHOT-runner`
...
- Amazon KMS ([guide](https://docs.quarkiverse.io/quarkus-amazon-services/dev/amazon-kms.html)): Connect to Amazon KMS
